  ...
  const findMaxNumber = (array) => {
    ...
    // Encontrar el máximo número en el array
  ...
  const agregarHabilidad = (jugador, nuevaHabilidad) => {
    ...
    */
        ...
        // Verificar si la nueva habilidad no existe en el arreglo de habilidades del jugador
...
/**
 * Función para filtrar películas por año de lanzamiento.
 * @param {Array} peliculas - Array de objetos que representan películas, cada objeto tiene una propiedad 'año'.
 * @param {number|string} año - Año de lanzamiento a filtrar, puede ser un número o un string.
 * @returns {Array} - Un array de objetos que representan películas lanzadas en el año especificado.
 */
const filtrarPorAño = (peliculas, año) => {
    // Filtrar las películas por año de lanzamiento
    return peliculas.filter(pelicula => {
        // Verificar si el año de la película coincide con el año proporcionado
...
class Automovil extends Vehiculo {
    ...
    constructor(marca, modelo, año, color, cilindrada, potencia, numPuertas, numAsientos, tipoTransmision) {
        ...
        // Inicialización de las propiedades específicas del automóvil
        this.color = color;
...
class Motocicleta extends Vehiculo {
    ...
    constructor(marca, modelo, año, color, cilindrada, potencia, numRuedas, tipo) {
        ...
        // Inicialización de las propiedades específicas de la motocicleta
        this.color = color;
        this.cilindrada = cilindrada;
        this.potencia = potencia;
...
class Camion extends Vehiculo {
    ...
    constructor(marca, modelo, año, color, cilindrada, potencia, numEjes, capacidadCarga, tipoCarroceria) {
        ...
        // Inicialización de las propiedades específicas del camión
        this.color = color;
        this.cilindrada = cilindrada;
        this.potencia = potencia;
...
class Autobus extends Vehiculo {
    ...
    constructor(marca, modelo, año, color, cilindrada, potencia, capacidadPasajeros, tipoCombustible, tipoMotor) {
        ...
        // Inicialización de las propiedades específicas del autobús
        this.color = color;
        this.cilindrada = cilindrada;
        this.potencia = potencia;
...
class Bicicleta extends Vehiculo {
    ...
    constructor(marca, modelo, año, tipo, numMarchas, material, suspencion, frenos, tipoManubrio) {
        ...
        // Inicialización de las propiedades específicas de la bicicleta
        this.tipo = tipo;
